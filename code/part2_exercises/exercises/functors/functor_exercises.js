...
var ex6 = _.compose(either(Left.of, _.compose(Right.of, showWelcome)), checkActive);
// = _.compose(_.map(showWelcome), checkActive)  // becuase __value: user
...
var ex8 = _.compose(either(emit, save), ex7);
